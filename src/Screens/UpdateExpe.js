...
export default function UpdateExperience({ navigation, route }) {
    ...
    let [referanceYes, setReferanceYes] = useState(route.params.ItemData.currently_work == 1 ? true : false);
    let [referanceNo, setReferanceNo] = useState(route.params.ItemData.currently_work == 0 ? true : false);
    let [SelectedIndex, setSelectedIndex] = useState()
    console.log('akkmadkdkad', route.params)
    //////////////////////////////////////////////
    function AddExpe() {
        let temData = {
            "title": '',
    ...
    const [ExpeArray, SetExpeArray] = useState([{
        ...
        "responsibility": route.params.ItemData.responsibility,
        "start_year": route.params.ItemData.start_year,
        "end_year": route.params.ItemData.end_year,
    ...
    const Updatenow = async () => {
        ...
        setAnimating(true)
        var data = ExpeArray[0]

        console.log(data, "apiData")
        let result = await put(data, 'update-experience');
 ...
 */}
                    ...
                    <Animatable.View animation="fadeInUp" >
                        ...
                        <TouchableOpacity style={styles.button} onPress={() => Updatenow()} >
