...
export default function TwoPersonalCharScreen({ navigation, route }) {
    ...
    const [self_emp, setself_emp] = useState("");
    ...
    const PersonChar = async () => {
        ...
        if (firstName1.trim() === "") {
            ...
            _toast("Ocuppation is required!.");
            return
        }
        else if (phoneNumber1.trim() === "") {
    ...
    const TwoPersonalChar = async () => {
        ...
        var data = {
            ...
            'address2': address2,
            'Known2': Known2,
            'self_emp': referanceNo,
        }
        console.log('data:', data)
        let result = await post(data, 'two_person_reference');
    ...
    const GoToSelfEmploymentRefScreen = () => {
            ...
            >
                ...
                <Animatable.View animation="fadeInUp" style={{ backgroundColor: "white" }} >
                    ...
                    <Animatable.View animation="fadeInUp" >
                        ...
                        <TouchableOpacity style={styles.button} onPress={() => PersonChar()} >
