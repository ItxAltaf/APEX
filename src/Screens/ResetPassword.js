...
export default function ResetPAssword({ navigation, route }) {
    ...
    const submit = async () => {
        ...
        let result = await put(data, 'new_password');
        console.log(result)
        if (result.status) {
            _toast('your password Changed');
            navigation.dispatch({
                ...CommonActions.reset({
                    index: 0,
                    routes: [{ name: 'signIn' }],
            ...
            >
                ...
                <Animatable.View animation="fadeInUp" style={{ backgroundColor: "white" }} >
                    ...
                    <Animatable.View animation="fadeInUp" >
                        ...
                        <TouchableOpacity style={styles.button} onPress={() => MatchSuccess()}>
